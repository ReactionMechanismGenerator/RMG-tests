...
# core:
python-jl $RMG_TESTING/scripts/checkModels.py $test_name $benchmark_model/chemkin/chem_annotated.inp $benchmark_model/chemkin/species_dictionary.txt $testing_model/chemkin/chem_annotated.inp $testing_model/chemkin/species_dictionary.txt
...
# edge:
python-jl $RMG_TESTING/scripts/checkModels.py $test_name $benchmark_model/chemkin/chem_edge_annotated.inp $benchmark_model/chemkin/species_edge_dictionary.txt $testing_model/chemkin/chem_edge_annotated.inp $testing_model/chemkin/species_edge_dictionary.txt
...
if [ -f "$regr" ];
then
  python-jl $RMG_TESTING/rmgpy/tools/regression.py $regr $benchmark_model/chemkin $testing_model/chemkin/
else
